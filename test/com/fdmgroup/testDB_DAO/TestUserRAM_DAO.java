...
//		users.put(1, mockUser1);
//		users.put(2, mockUser2);
//		users.put(3, mockUser3);
//		
//		stocks = new HashMap<Integer, Stock>();
//		
//		tradeOrders = new HashMap<Integer, TradeOrder>();
	}
	
	@Test
	public void testCreateDTO_User(){
		UserRAM_DAO<User> crud = new UserRAM_DAO<User>();
		crud.create(mockUser1);
		assertTrue(crud.read(1).equals(mockUser1));
	}
	
	@Test
	public void testCreateDTO_UserWhenUserIDdupicatesNotCreate(){
		UserRAM_DAO<User> crud = new UserRAM_DAO<User>();
		crud.create(mockUser1);
		assertFalse(crud.create(mockUser1));
	}
	
	@Test
	public void testCreateDTO_UserWhenUserRAMisNull(){
		UserRAM_DAO<User> crud = new UserRAM_DAO<User>();
		crud.create(mockUser1);
		assertTrue(crud.read(1).equals(mockUser1));
	}
	...
	@Test 
	public void testReadDTO_User(){
		UserRAM_DAO<User> crud = new UserRAM_DAO<User>();
		crud.create(mockUser3);
		User readUser = crud.read(3);
		assertTrue(readUser.getUsername().equals("James3's username"));
	}
	
	@Test 
	public void testReadDTO_UserWhenNotSuchDTO(){
		UserRAM_DAO<User> crud = new UserRAM_DAO<User>();
		crud.create(mockUser3);
		User readUser = crud.read(1);
		assertTrue(readUser==null);
	}
	
	@Test 
	public void testReadDTO_UserWhenDAOisNull(){
		UserRAM_DAO<User> crud = new UserRAM_DAO<User>();
	...
	@Test 
	public void testUpdateDTO_User(){
		User updatedUser3 = new User("James3", "changepassword", permissions2);
		updatedUser3.setDtoID(3);
		UserRAM_DAO<User> crud = new UserRAM_DAO<User>();
		crud.create(mockUser3);
		crud.update(updatedUser3);
		assertTrue(crud.read(3).getPassword().equalsIgnoreCase("changepassword"));
	}
	
	@Test 
	public void testUpdateDTO_UserWhenDAOisNull(){
		User updatedUser3 = new User("James3", "changepassword", permissions2);
		updatedUser3.setDtoID(3);
		UserRAM_DAO<User> crud = new UserRAM_DAO<User>();	
		assertTrue(crud.update(updatedUser3)==false);
	}
	
	@Test 
	public void testUpdateDTO_UserWhenNotSuchID(){
		User updatedUser3 = new User("James3", "changepassword", permissions2);
		updatedUser3.setDtoID(4);
		UserRAM_DAO<User> crud = new UserRAM_DAO<User>();
		crud.create(mockUser3);
		assertTrue(crud.update(updatedUser3)==false);
	}
	...
	@Test 
	public void testDeleteDTO_UserWhenDAOisNull(){
		UserRAM_DAO<User> crud = new UserRAM_DAO<User>();
		assertTrue(crud.delete(mockUser3)==false);
	}
	
	@Test 
	public void testDeleteDTO_UserWhenNotSuchID(){
		UserRAM_DAO<User> crud = new UserRAM_DAO<User>();
		crud.create(mockUser3);
		
		assertTrue(crud.delete(mockUser2)==false);
	}
